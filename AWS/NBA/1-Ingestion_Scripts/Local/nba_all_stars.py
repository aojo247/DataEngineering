...
url = f"https://www.basketball-reference.com/awards/all_star_by_player.html"
...
s3 = save_to_s3_bucket(final_df, <s3_bucket_name here >, 'NBA/raw/nba_all_star_list.csv', 'default')
'''
