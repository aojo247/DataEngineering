...
def lambda_handler(event, context):
    ...
    source_s3_object_key = 'NBA/raw/nba_stats.csv'  # Set the desired object key for the raw file (remember- you still need to run a cleaning script)
    destination_s3_object_key = 'NBA/cleaned/nba_stats.csv'
    ...
    nba_stats_cols_to_remove = ["Rk"]
    
    df = df.drop(columns= nba_stats_cols_to_remove)
